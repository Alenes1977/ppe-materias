    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="container mx-auto px-4 pb-14 pt-24">
        ...
        <div className="space-y-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {asignaturaInfo.competencias.map((competencia, index) => (
                      <Link
                        key={index}
                        to="/competencias"
                        className="group relative inline-flex items-center rounded-full bg-gradient-to-r from-blue-50 to-blue-100 px-4 py-2 text-sm font-medium text-blue-800 transition-all hover:from-blue-100 hover:to-blue-200"
                        title={getCompetenciaDescripcion(competencia)}
                      >
                        <span>{competencia}</span>
                        {/* Tooltip personalizado */}
                        <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 w-72 -translate-x-1/2 transform rounded-lg bg-gray-900 p-2 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100">
          ...
          {/* Actividades formativas - Versión más compacta */}
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 flex items-center text-xl font-bold text-gray-800">
              <FontAwesomeIcon
                icon={faBookOpen}
